...
class AIDebater:
    ...
    def generate_response(
        ...
        # 키워드 문자열 구성
        keywords_str = ", ".join(self.keywords) if self.keywords else "정치, 사회"
...
- 주제 키워드({keywords_str})와 관련된 새로운 논점을 제시하세요.
- 2-3문장으로 간결하게 작성하세요.
...
class DebaterManager:
    ...
    def __init__(
        ...
        print(f"📌 토론 키워드: {', '.join(self.keywords) if self.keywords else '(없음)'}")
